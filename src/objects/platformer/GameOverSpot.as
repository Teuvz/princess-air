package objects.platformer
{
	 ...
	 */	
	public class GameOverSpot extends PhysicsObject
	{
		/**
		...
		public static function Make(name:String, x:Number, y:Number, width:Number, height:Number, view:* = null):GameOverSpot
		{
			if (view == null) view = MovieClip;
			return new GameOverSpot(name, { x: x, y: y, width: width, height: height, view: view } );
		}
		
		public function GameOverSpot(name:String, params:Object=null)
		{
			super(name, params);
