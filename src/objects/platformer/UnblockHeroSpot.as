package objects.platformer
{
	 ...
	 */	
	public class UnblockHeroSpot extends PhysicsObject
	{
		/**
		...
		public static function Make(name:String, x:Number, y:Number, width:Number, height:Number, view:* = null):UnblockHeroSpot
		{
			if (view == null) view = MovieClip;
			return new UnblockHeroSpot(name, { x: x, y: y, width: width, height: height, view: view } );
		}
		
		public function UnblockHeroSpot(name:String, params:Object=null)
		{
			super(name, params);
