package objects.platformer
{
	 ...
	 */	
	public class JumpSpot extends PhysicsObject
	{
		/**
		...
		public static function Make(name:String, x:Number, y:Number, width:Number, height:Number, view:* = null):JumpSpot
		{
			if (view == null) view = MovieClip;
			return new JumpSpot(name, { x: x, y: y, width: width, height: height, view: view } );
		}
		
		public function JumpSpot(name:String, params:Object=null)
		{
			super(name, params);
