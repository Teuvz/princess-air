package objects.platformer
{
	 ...
	 */	
	public class TeleportSpot extends PhysicsObject
	{
		/**
		...
		[Property(value="throne")]
		public var level:String = 'throne';
		
		public static function Make(name:String, x:Number, y:Number, width:Number, height:Number, view:* = null):TeleportSpot
		{
			if (view == null) view = MovieClip;
			return new TeleportSpot(name, { x: x, y: y, width: width, height: height, view: view } );
		}
		
		public function TeleportSpot(name:String, params:Object=null)
		{
			super(name, params);
