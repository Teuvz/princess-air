package objects.platformer
{
	 ...
	 */	
	public class DestroySpot extends PhysicsObject
	{
		/**
		...
		public static function Make(name:String, x:Number, y:Number, width:Number, height:Number, view:* = null):DestroySpot
		{
			if (view == null) view = MovieClip;
			return new DestroySpot(name, { x: x, y: y, width: width, height: height, view: view } );
		}
		
		public function DestroySpot(name:String, params:Object=null)
		{
			super(name, params);
