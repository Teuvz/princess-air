package objects.platformer
{
	 ...
	 */	
	public class Checkpoint extends PhysicsObject
	{
		/**
		...
		public static function Make(name:String, x:Number, y:Number, width:Number, height:Number, view:* = null):Checkpoint
		{
			if (view == null) view = MovieClip;
			return new Checkpoint(name, { x: x, y: y, width: width, height: height, view: view } );
		}
