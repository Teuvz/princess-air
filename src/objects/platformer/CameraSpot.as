package objects.platformer
{
	 ...
	 */	
	public class CameraSpot extends PhysicsObject
	{
		/**
		...
		public var fixOnTouch:Boolean = false;
			
		public static function Make(name:String, x:Number, y:Number, width:Number, height:Number, view:* = null):CameraSpot
		{
			if (view == null) view = MovieClip;
			return new CameraSpot(name, { x: x, y: y, width: width, height: height, view: view } );
		}
		
		public function CameraSpot(name:String, params:Object=null)
		{
			super(name, params);
