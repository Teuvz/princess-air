package objects.platformer
{
	 ...
	 */	
	public class StartSpot extends PhysicsObject
	{
		/**
		...
		public static function Make(name:String, x:Number, y:Number, width:Number, height:Number, view:* = null):StartSpot
		{
			if (view == null) view = MovieClip;
			return new StartSpot(name, { x: x, y: y, width: width, height: height, view: view } );
		}
		
		public function StartSpot(name:String, params:Object=null)
		{
			super(name, params);
