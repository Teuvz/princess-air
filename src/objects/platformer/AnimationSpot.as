package objects.platformer
{
	 ...
	 */	
	public class AnimationSpot extends PhysicsObject
	{
		/**
		...
		[Property(value="")]
		public var cinematic:String = "";
			
		public static function Make(name:String, x:Number, y:Number, width:Number, height:Number, view:* = null):AnimationSpot
		{			
			if (view == null) view = MovieClip;
			return new AnimationSpot(name, { x: x, y: y, width: width, height: height, view: view } );
		}
		
		public function AnimationSpot(name:String, params:Object=null)
		{
			super(name, params);
