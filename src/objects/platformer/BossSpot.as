package objects.platformer
{
	 ...
	 */	
	public class BossSpot extends PhysicsObject
	{
		
		[Property(value="BossCamera")]
		public var cameraName:String = 'BossCamera';
		
		[Property(value="Boss")]
		public var bossName:String = 'Boss';
		...
		public static function Make(name:String, x:Number, y:Number, width:Number, height:Number, view:* = null):BossSpot
		{
			if (view == null) view = MovieClip;
			return new BossSpot(name, { x: x, y: y, width: width, height: height, view: view } );
		}
		
		public function BossSpot(name:String, params:Object=null)
		{
			super(name, params);
