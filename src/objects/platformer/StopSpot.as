package objects.platformer
{
	 ...
	 */	
	public class StopSpot extends PhysicsObject
	{
		/**
		...
		[Property(value="true")]
		public var deleteOnTouch:Boolean = true;
		
		public static function Make(name:String, x:Number, y:Number, width:Number, height:Number, view:* = null):StopSpot
		{
			if (view == null) view = MovieClip;
			return new StopSpot(name, { x: x, y: y, width: width, height: height, view: view } );
		}
		
		public function StopSpot(name:String, params:Object=null)
		{
			super(name, params);
