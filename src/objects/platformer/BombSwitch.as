package objects.platformer
{
	 ...
	 */	
	public class BombSwitch extends PhysicsObject
	{
		/**
		...
		public static function Make(name:String, x:Number, y:Number, width:Number, height:Number, view:* = null):BombSwitch
		{
			if (view == null) view = MovieClip;
			return new BombSwitch(name, { x: x, y: y, width: width, height: height, view: view } );
		}
		
		public function BombSwitch(name:String, params:Object=null)
		{
			super(name, params);
