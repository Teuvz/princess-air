package objects.platformer
{
	 ...
	 */
	public class PrincessPlatform extends PhysicsObject
	{
		private var _oneWay:Boolean = false;
				
		public static function Make(name:String, x:Number, y:Number, width:Number, height:Number):PrincessPlatform
		{
			return new PrincessPlatform(name, { x: x, y: y, width: width, height: height } );
		}
