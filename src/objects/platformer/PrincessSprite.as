package objects.platformer
{
	 ...
	 */	
	public class PrincessSprite extends CitrusObject implements ISpriteView
	{
		public var velocity:MathVector = new MathVector();
		public var collisions:Dictionary = new Dictionary();
		
		public var onCollide:Signal = new Signal(PrincessSprite, PrincessSprite, MathVector, Number);
		public var onPersist:Signal = new Signal(PrincessSprite, PrincessSprite, MathVector);
		public var onSeparate:Signal = new Signal(PrincessSprite, PrincessSprite);
		...
		public static function Make(name:String, x:Number, y:Number, view:*, parallax:Number = 1):PrincessSprite
		{
			return new PrincessSprite(name, { x: x, y: y, view: view, parallax: parallax } );
		}
