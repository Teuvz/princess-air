package objects.platformer
{
	 ...
	 */	
	public class DirectionSpot extends PhysicsObject
	{
		/**
		...
		public static function Make(name:String, x:Number, y:Number, width:Number, height:Number, view:* = null):DirectionSpot
		{
			if (view == null) view = MovieClip;
			return new DirectionSpot(name, { x: x, y: y, width: width, height: height, view: view } );
		}
		
		public function DirectionSpot(name:String, params:Object=null)
		{
			super(name, params);
