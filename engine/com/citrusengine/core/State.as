package com.citrusengine.core
{
	...
	{
		protected var _objects:Vector.<CitrusObject> = new Vector.<CitrusObject>();
		...
		public function startBossFight( spot:BossSpot ) : void { }
		public function showDialog( text:String, time:uint, fullscreen:Boolean ) : void { }	
		public function hideDialog() : void { }	
		public function activateCheckpoint( checkpoint:Checkpoint ) : void { }	
		public function setPrincessStartPosition( x:uint, y:uint ) : void { }
		public function playCinematic( name:String ) : void { }	
		public function setKnightHealth( value:uint ) : void { }
		public function getKnightHealth() : uint { return 0; }
		public function changeLevel( lvl:String ) : uint { return 0; }
